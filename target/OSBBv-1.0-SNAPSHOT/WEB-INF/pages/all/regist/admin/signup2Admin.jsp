...
<div id="section1" class="container-fluid">
    <div class="container">
        <form role="form" enctype="multipart/form-data" class="form-horizontal" action="/all/reg/admin/buildInfo"
              method="post">
            ...
            <div class="form-group">
                <div class="col-md-4">
                    <input type="text" class="form-control" name="flatCnt" placeholder="Количество квартир" required>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-4">
            ...
            <div class="form-group">
                <div class="col-md-4">
                    <input type="text" class="form-control" name="buildNum" placeholder="Номер Дома" required>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-4">
